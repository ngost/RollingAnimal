...
{
    public static int LoadLastPlayStageNum()
    {
        return PlayerPrefs.GetInt("LastPlayStage", 1);
    }
    public static void SaveLastPlayStageNum(int num)
    {
        PlayerPrefs.SetInt("LastPlayStage", num);
    }

    public static int LoadFeverItemIsUsing()
    {
        return PlayerPrefs.GetInt("FeverItemUsing", 1);
    }
    public static int LoadShieldItemIsUsing()
    {
        return PlayerPrefs.GetInt("ShieldItemUsing", 1);
    }
    public static int LoadRewardItemIsUsing()
    {
        return PlayerPrefs.GetInt("RewardItemUsing", 1);
    }

    public static void SetShieldItemIsUsing(int val)
    {
        PlayerPrefs.SetInt("ShieldItemUsing", val);
    }
    public static void SetFeverItemUsing(int val)
    {
        PlayerPrefs.SetInt("FeverItemUsing", val);
    }

    public static void SetRewardItemUsing(int val)
    {
        PlayerPrefs.SetInt("RewardItemUsing", val);
    }
